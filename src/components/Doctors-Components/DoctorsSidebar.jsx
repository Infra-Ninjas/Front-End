...
import { assets } from "../../assets/assets_admin/assets.js"; // Or actual location
    ...
    <>
      ...
      <div className="d-flex">
        ...
        <div
          ...
          style={{
            marginLeft: dToken ? "200px" : "0px",
            width: dToken ? "calc(100% - 200px)" : "100%",
            padding: "3px 4px",
            paddingTop: "1px",
            backgroundColor: "transparent"
          }}
        >
          {/* Doctor pages (Dashboard, Patients, Profile) render here */}
        </div>
      </div>
    </>
  );
