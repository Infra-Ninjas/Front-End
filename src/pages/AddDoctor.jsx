...
//       if (docImg) {
//         // 1) If an image file is uploaded, we typically:
//         //    - Upload it to a storage (S3, Cloudinary, etc.)
//         //    - Get the URL from the storage
//         //    - Save that URL in the "image" field.
//         //    For demonstration, let's assume the backend will handle
//         //    storing the file and returning a URL.
//         //    So we'll send FormData with the file.

//         payload = new FormData();
//         payload.append("name", name);
//         payload.append("email", email);
//         payload.append("password", password);
//         payload.append("image", docImg); // The file; backend must store & map to a URL
...
//         payload.append("date", currentTimestamp);       // <-- The required date field
//         payload.append("slots_booked", JSON.stringify({})); // <-- Must be an object
...
//         };
//       } else {
//         // 2) Otherwise, if an image URL is provided, send JSON
//         //    with "image" set to that URL.
//         payload = {
//           name,
//           email,
//           password,
...
//           date: currentTimestamp,    // required
//           slots_booked: {}
//         };
...
//           {/* Optional input field for an Image URL (if you want to let the user specify a URL) */}
//           <div className="mt-3">
