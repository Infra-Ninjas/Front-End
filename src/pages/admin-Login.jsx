...
const Login = () => {
  ...
  const { setAToken } = useContext(AdminContext); // ✅ Correct usage
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      if (state === "Admin") {
        ...
        console.log("Doctor login functionality pending...");
      }
    } catch (error) {
  ...
  return (
    <div className="d-flex justify-content-center align-items-center vh-100 bg-light">
      <form onSubmit={onSubmitHandler} className="p-4 rounded shadow-lg bg-white" style={{ width: "100%", maxWidth: "400px" }}>
        {/* Header */}
        <div className="text-center mb-4">
          <img src={assets.logo} alt="Logo" className="mb-3" style={{ width: "60px" }} />
        ...
        <div className="mb-3">
          ...
          <input onChange={(e) => setPassword(e.target.value)} value={password} type="password" className="form-control" required />
        </div>
